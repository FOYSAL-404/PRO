...
{A}╔════════════════════════════════════════════════════════════════════════════════════════╗
{A}║                            {O} MULTI {K}BRUTEFORCE {U}ERROR                             {A}║
{A}║                            {A} AUTHOR    {P}: {H}Abraham Islam Foysal                                       {A}║
{A}║                            {A} Github    {P}: {H}github.com/FOYSAL-404                        {A}║
{A}║                            {A} Facebook  {P}: {H}FOYSAL HOSEN                                   {A}║
{A}╚════════════════════════════════════════════════════════════════════════════════════════╝
""")
#Licensi
___licensi___ = (f"""{H}
...
def xoshnaw():
  ...
  try:
    httpCaht = requests.get("https://github.com/FOYSAL-404/blob/main/agent.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+8801793268786?text=')
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def ___login___():
    ...
    if ___cookie in ['open', 'Open', 'OPEN']:
        print(f"{A}╚═➣{M} You will be directed to the creator of this program !!!");sleep(3);os.system('xdg-open https://wa.me/+8801793268786?text=Bg+Cara+Ambil+Cookies+Ig+Kek+Mana?');___login___()
    elif ___cookie in ['', ' ']:
